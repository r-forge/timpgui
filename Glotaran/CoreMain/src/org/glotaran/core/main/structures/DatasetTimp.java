package org.glotaran.core.main.structures;
...
public final class DatasetTimp implements DatasetTimpInterface{
     ...
     * @return
     */
    public int getOriginalHeight(){return orheight;}
    /**
     *
     * @return
     */
    public int getOriginalWidth(){return orwidth;}
    /**
     *
     * @return
     */
     ...
     * @param ntvalue
     */
    public void setNt(int ntvalue){nt = ntvalue;}
    /**
     *
     * @param nlvalue
     */
    public void setNl(int nlvalue){nl = nlvalue;}
    /**
     * 
     * @param orheightValue
     */
    public void setOrigHeigh(int orheightValue){orheight = orheightValue;}
    /**
     *
     * @param orwidthValue
     */
    public void setOrigWidth(int orwidthValue){orwidth = orwidthValue;}
    /**
     *
     * @param psisimValue
     */
