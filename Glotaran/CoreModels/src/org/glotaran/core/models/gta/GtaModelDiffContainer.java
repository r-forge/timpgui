 ...
 *         &lt;element name="changes" type="{http://www.nat.vu.nl/~jsnel/Schema/TgmSchema}Dat" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GtaModelDiffContainer {
     ...
     * 
     */
    public List<Dat> getChanges() {
        if (changes == null) {
            changes = new ArrayList<Dat>();
        }
        return this.changes;
    }
