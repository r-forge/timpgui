...
@XmlRootElement(name = "GtaProjectScheme", namespace = "http://glotaran.org/schema/GlobalAndTargetAnalysisSchema")
public class GtaProjectScheme {

    @XmlElement(namespace = "http://glotaran.org/schema/GlobalAndTargetAnalysisSchema", nillable = true)
    protected List<GtaDatasetContainer> datasetContainer;
    @XmlElement(namespace = "http://glotaran.org/schema/GlobalAndTargetAnalysisSchema", nillable = true)
    protected List<GtaModelReference> model;
    @XmlElement(namespace = "http://glotaran.org/schema/GlobalAndTargetAnalysisSchema", required = true, nillable = true)
    ...
    @XmlElement(namespace = "http://glotaran.org/schema/GlobalAndTargetAnalysisSchema", required = true)
