 ...
 * @author Ralf
 */
public class JRJava2RConnection implements IJava2RConnection{

    private final IRConnection irConnection;
    private final RConnection connection;

    JRJava2RConnection(final JRClientRconnection con) {
        this.irConnection = con;
        this.connection = con.delegate;
    }
