 ...
 *         &lt;element name="jVector" type="{http://www.w3.org/2001/XMLSchema}double" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class KMatrixPanelModel {
     ...
     * 
     */
    public List<Double> getJVector() {
        if (jVector == null) {
            jVector = new ArrayList<Double>();
        }
        return this.jVector;
    }
