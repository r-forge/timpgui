 ...
 * @author slk230
 */
public class ModelSpecificationContainer extends javax.swing.JPanel implements ExplorerManager.Provider, Lookup.Provider {
...
//    static final String ICON_PATH = "SET/PATH/TO/ICON/HERE";
    ...
    public ModelSpecificationContainer() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(ModelSpecificationContainer.class, "ModelSpecificationContainer.border.title"))); // NOI18N
        ...
        remove.setText(org.openide.util.NbBundle.getMessage(ModelSpecificationContainer.class, "ModelSpecificationContainer.remove.text")); // NOI18N
        remove.setToolTipText(org.openide.util.NbBundle.getMessage(ModelSpecificationContainer.class, "ModelSpecificationContainer.remove.toolTipText")); // NOI18N
