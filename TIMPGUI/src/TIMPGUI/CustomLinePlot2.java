 ...
 */
public class CustomLinePlot2 extends ApplicationFrame {
     ...
     *            the frame title.
     */
    public CustomLinePlot2(String title) {
        super(title);
    ...
    public static void main(String[] args) {
        CustomLinePlot2 demo = new CustomLinePlot2("Crosshair Demo 2");
        demo.pack();
